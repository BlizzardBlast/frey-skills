...
Behavioral model evals are not run or required for `debug`. Existing scorecards
in this directory are legacy reference artifacts. They are not merge evidence
and must not be presented as certification that model behavior was tested.
